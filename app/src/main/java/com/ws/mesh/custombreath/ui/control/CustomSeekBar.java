package com.ws.mesh.custombreath.ui.control;
...
public class CustomSeekBar extends View implements View.OnTouchListener {
     ...
     *
     * @param process      当前进度
     * @param needCallBack 判断是否需要动画过程的process值回调
     */
    public void setProcessWithAnimation(int process, final boolean needCallBack) {
        synchronized (this) {
